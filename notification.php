  	...
  	<!--==TRENDS==-->
			...
			<div class="notification-wrapper">
				<div class="notification-inner">
					<div class="notification-header">
						...
						<a href="<?php echo BASE_URL.$data->username;?>" class="notifi-name"><?php echo $data->screenName;?></a><span> Followed you - <span><?php echo $getFromUser->timeAgo($data->time);?></span>
		...
		<?php if($data->type == 'like') :?>
			...
			<div class="notification-wrapper">
				<div class="notification-inner">
					...
					<div class="notification-tweet">
						<a href="<?php echo BASE_URL.$data->profileImage;?>" class="notifi-name"><?php echo $data->screenName;?></a><span> liked your <?php if($data->tweetBy === $user_id){echo 'Tweet';}else{echo 'Retweet';}?> - <span><?php echo $getFromUser->timeAgo($data->time);?></span>
					</div>
								...
								<div class="t-show-head">
									...
									<div class="t-s-head-co	ntent">
										<div class="t-h-c-name">
											...
											<span>'.$getFromTweet->timeAgo($tweet->postedOn).'</span>
										</div>
										<div class="t-h-c-dis">
		...
		<div class="in-right"	>
			<div class="in-right-wrap">
		 	...
		 	<!--Who To Follow-->
 		      <?php $getFromFollow->whoToFollow($user_id, $user->user_id);?>
      		<!--Who To Follow-->
