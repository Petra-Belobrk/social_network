...
if(isset($_POST['showpopup']) && !empty($_POST['showpopup'])){
    ...
    $tweet   = $getFromTweet->tweetPopup($tweetID);
...
<!--                        --><?php //echo $getFromFollow->followBtn($tweet->tweetBy, $user_id, $user_id);?>
                    </div>
                </div>
                ...
                <div class="tweet-show-popup-footer-wrap">
                    ...
                    <div class="tweet-show-popup-time">
                        <span><?php echo $getFromUser->timeAgo($tweet->postedOn);?></span>
                    </div>
