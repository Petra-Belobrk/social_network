...
if(isset($_POST['showImage']) && !empty($_POST['showImage'])){
		...
		$tweet      = $getFromTweet->tweetPopup($tweet_id);
			...
			<div class="img-popup-tweet-wrap-inner">
				...
				<div class="img-popup-tweet-right">
					<div class="img-popup-tweet-right-headline">
						<a href="<?php echo BASE_URL.$tweet->username;?>"><?php echo $tweet->screenName;?></a><span>@<?php echo $tweet->username . ' - ' .$getFromUser->timeAgo($tweet->postedOn)	;?></span>
					</div>
