...
class Tweet extends User{
        ...
        foreach ($tweets as $tweet) {
            ...
            echo '<div class="all-tweet">
			      <div class="t-show-wrap">
			       ...
			       '.(($retweet['retweetID'] === $tweet->retweetID || $tweet->retweetID > 0) ? '
			        ...
			        '.((!empty($tweet->retweetMsg) && $tweet->tweetID === $retweet['tweetID'] || $tweet->retweetID > 0) ? '<div class="t-show-head">
    ...
    public function unlike($user_id, $tweet_id, $get_id) {
        ...
        $stmt2 = $this->pdo->prepare("DELETE FROM likes WHERE likeBy = :user_id AND likeOn = :tweet_id");
        $stmt2->bindParam(":user_id", $user_id, PDO::PARAM_INT);
        $stmt2->bindParam(":tweet_id", $tweet_id, PDO::PARAM_INT);
        $stmt2->execute();
